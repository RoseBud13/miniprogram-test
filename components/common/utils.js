...
export const unitConvert = (value) => {
  ...
  if (typeof value === 'string') {
    if (value.includes('rpx')) {
      return (
        (parseInt(value, 10) *
          ((_a = systemInfo === null || systemInfo === void 0 ? void 0 : systemInfo.screenWidth) !== null &&
          _a !== void 0
            ? _a
            : 750)) /
        750
...
export const isOverSize = (size, sizeLimit) => {
  ...
  const computedSize =
    typeof sizeLimit === 'number'
      ? sizeLimit * base
      : (sizeLimit === null || sizeLimit === void 0 ? void 0 : sizeLimit.size) *
        unitMap[
          (_a = sizeLimit === null || sizeLimit === void 0 ? void 0 : sizeLimit.unit) !== null && _a !== void 0
            ? _a
            : 'KB'
        ];
